/*! kodi-webinterface by Jeremy Graham - built on 30-01-2015 */
...
(function(factory) {
    if (typeof define === "function" && define.amd) {
        if (typeof window == "undefined") global.window = require("jsdom").jsdom().createWindow();
    ...
    RPC2.Util = {
        ...
        recursivelyInheritRpcOptions: function(rpcOptions, superRpcOptions, parentKey) {
            var dontRecursivelyInherit = [ "rpcOptions.headers", "methods.create", "methods.read", "methods.update", "methods.delete" ];
            var model = this;
